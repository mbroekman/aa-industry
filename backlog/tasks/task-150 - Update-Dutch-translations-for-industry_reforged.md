...
1. Vertaal alle nieuwe en niet-vertaalde strings naar natuurlijk, correct Nederlands passend bij EVE Online en Alliance Auth.
1. Draai `compilemessages` om de binaire `django.mo` catalogus bij te werken.
1. Controleer dat het project en de tests foutloos draaien.
