...
class MarketOpportunity(models.Model):
    ...
    forecasted_velocity = models.FloatField(
        null=True, blank=True, help_text=_("AI Forecasted Daily Volume")
    )
    ai_confidence_score = models.FloatField(
        null=True, blank=True, help_text=_("AI Confidence Score (0-1)")
    )
